    ...
    <div class="container main-header">
        <div class="row">
            <div class="col-xs-12 col-sm-3 logo">
                <a href="index.html"><img alt="Kute shop" src="{{URL::to('public/theme_assets/images/logo.png')}}" /></a>
            </div>
                    ...
                    <div id="product">
                        <div class="primary-box row">
                            <div class="pb-left-column col-xs-12 col-sm-6">
                                ...
                                <div class="product-image">
                                    <div class="product-full">
                                        <img id="product-zoom" src="{{ asset($pro_detail->product_image )}}"/>
                                    </div>
                            ...
                            <div class="pb-right-column col-xs-12 col-sm-6">
                                <h1 class="product-name">{{ $pro_detail->product_name }}</h1>
                                ...
                                <div class="product-price-group">
                                    <span class="price">BDT {{$pro_detail->new_price}}</span>
                                    <span class="old-price"> BDT {{$pro_detail->old_price}}</span>
                                ...
                                <div class="info-orther">
                                    ...
                                    @elseif($pro_detail->product_quantity < 2)
                                    <p>Availability: <span class="in-stock">Limited(Hurry Up)</span></p>
                                    @else
                                ...
                                <div class="product-desc">
                                    {{ strip_tags($pro_detail->product_description) }}
                                </div>
                        ...
                        <div class="product-tab">
                            ...
                            <div class="tab-container">
                                <div id="product-detail" class="tab-panel active">
                                    ...
                                    <h4>{{ strip_tags($pro_detail->product_description) }}</h4>
                                    <br>
